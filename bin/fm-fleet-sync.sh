...
# branch is gone (the remote branch was deleted, i.e. its PR/MR merged) and that no
...
prune_gone_branches() {
  ...
  # branch was deleted, which in this fleet means its PR/MR merged - as long as
  ...
  # do NOT also require the branch to be an ancestor of origin/<default> - reviews in
