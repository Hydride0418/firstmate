...
| `fm-dashboard.sh`        | Render a read-only HTML fleet dashboard from this home's `state/` and `data/backlog.md`, or serve it locally with auto-refresh and pid/log files under `.lavish/fm-dashboard/` |
