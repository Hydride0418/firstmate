...
make_fake_root() {
  ...
  # fm-review-provider-lib.sh: symlink the REAL file (teardown sources it for the
  # provider-aware landed-detection; unchanged by this fixture).
  ln -s "$ROOT/bin/fm-review-provider-lib.sh" "$fake/bin/fm-review-provider-lib.sh"
